...
public class RedBuildzone2 extends LinearOpMode{
   ...
   ColorSensor colorSensor;
    ...
    rC = hardwareMap.get(CRServo.class, "leftClamp");
    lC = hardwareMap.get(CRServo.class, "rightClamp");
    ...
    */
    ...
    waitForStart();
        ...
        // while(gyroSensor)
        // strafeRight(.8, 100, 2000);
        // openClamp();
        // elevUpDwn(1, 300);
        // // move directly backwards
        // fwdBwd(-1, 240, 2000);       //Because our robot has a length of 18 inches it has that much room for error
        // brake();
     ...
     */
     public void fwdBwd(double power, int milliSeconds){
    ...
    public void elevUpDwn(double power, int milliSeconds) {
